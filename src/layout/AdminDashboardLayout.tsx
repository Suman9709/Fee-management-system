      ...
      <div className="drawer-content flex min-h-screen flex-col">
        <header className="sticky top-0 z-30 flex h-[72px] shrink-0 items-center border-b border-slate-200/80 bg-white/95 px-4 backdrop-blur sm:px-7">
          <label
            ...
            className="mr-2 inline-flex size-10 items-center justify-center rounded-lg text-slate-600 transition hover:bg-slate-100 lg:hidden"
          >
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            <label className="hidden h-10 w-60 items-center gap-2 rounded-lg border border-slate-200 bg-slate-50 px-3 text-sm text-slate-400 lg:flex">
              <Search className="size-4" />
              <input className="min-w-0 flex-1 bg-transparent outline-none placeholder:text-slate-400" placeholder="Search anything" />
            </label>
            <button aria-label="Notifications" className="relative inline-flex size-10 items-center justify-center rounded-lg border border-slate-200 bg-white text-slate-500 transition hover:bg-slate-50 hover:text-slate-700">
      ...
      <div className="drawer-side z-40">
        ...
        <aside className="flex min-h-full w-[272px] flex-col border-r border-slate-800 bg-[#0f172a] shadow-2xl shadow-slate-950/20">
          ...
          <nav className="flex-1 overflow-y-auto px-3 py-6" aria-label="Admin navigation">
            <p className="mb-2 px-3 text-[11px] font-bold tracking-[0.12em] text-slate-500 uppercase">Main menu</p>
            ...
            <p className="mb-2 mt-7 px-3 text-[11px] font-bold tracking-[0.12em] text-slate-500 uppercase">System</p>
            <NavLink
              to="/admin/settings"
              className={({ isActive }) =>
                `flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-all ${
